...
Description:
Demonstrate convolution in Real Time by camera
Visualize object contour
Compute and draw bounding box by contours coordinates

File: convolution_in_real_time.py
"""
...
cv2.namedWindow('Spent time', cv2.WINDOW_NORMAL)
...
# camera = cv2.VideoCapture('videos/fish.mp4')
...
while True:
    ...
    if contours:
        ...
        cv2.putText(temp, label, (100, 200),
