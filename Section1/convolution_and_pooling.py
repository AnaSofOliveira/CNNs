...
# or:
# 'images\\cat.png'
image_BGR = cv2.imread('Section1/images/cat.png')
...
figure.savefig('Section1/images/plot_convolution_and_pooling.png')

# Giving name to the window with figure
#figure.canvas.set_window_title('Convolution and Pooling to GRAY image')
plt.title('Convolution and Pooling to GRAY image')
