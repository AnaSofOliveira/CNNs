...
# to this: + '\' +
# or to this: + '\\' +
with h5py.File(full_path_to_Section2 + '/' + 'dataset_custom.hdf5', 'r') as f:
...
# Initiating File object
# Creating file with name 'dataset_custom_gray_255.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('custom' + '/' + 'dataset_custom_gray_255.hdf5', 'w') as f:
...
# Initiating File object
# Creating file with name 'mean_gray_dataset_custom.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('custom' + '/' + 'mean_gray_dataset_custom.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
...
# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_custom_gray_255_mean.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('custom' + '/' + 'dataset_custom_gray_255_mean.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
...
# Initiating File object
# Creating file with name 'std_gray_dataset_custom.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('custom' + '/' + 'std_gray_dataset_custom.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
...
# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_custom_gray_255_mean_std.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('custom' + '/' + 'dataset_custom_gray_255_mean_std.hdf5', 'w') \
        as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
...
# to this: + '\' +
# or to this: + '\\' +
with h5py.File(full_path_to_Section2 + '/' + 'dataset_mnist.hdf5', 'r') as f:
    # Extracting saved arrays for training by appropriate keys
    # Saving them into new variables
    x_train = f['x_train']  # HDF5 dataset
    y_train = f['y_train']  # HDF5 dataset
...
# Check point
# Showing shapes of Numpy arrays with GRAY images
print('Numpy arrays of MNIST Dataset')
print(x_train.shape)
print(x_validation.shape)
print(x_test.shape)
print()
...
# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_mnist_gray_255.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('mnist' + '/' + 'dataset_mnist_gray_255.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# (!) We calculate Mean Image only from training dataset
# And apply it to all sub-datasets
mean_gray_dataset_mnist = np.mean(x_train_255, axis=0)  # (28, 28, 1)
...
# Pixels' values are now in some range (from negative to positive),
# where the mean lies at zero
x_train_255_mean = x_train_255 - mean_gray_dataset_mnist
x_validation_255_mean = x_validation_255 - mean_gray_dataset_mnist
x_test_255_mean = x_test_255 - mean_gray_dataset_mnist

# Saving Mean Image to use it later in the course
# Initiating File object
# Creating file with name 'mean_gray_dataset_mnist.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('mnist' + '/' + 'mean_gray_dataset_mnist.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
    f.create_dataset('mean', data=mean_gray_dataset_mnist, dtype='f')


# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_mnist_gray_255_mean.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('mnist' + '/' + 'dataset_mnist_gray_255_mean.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255_mean, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# (!) We calculate Standard Deviation only from training dataset
# And apply it to all sub-datasets
std_gray_dataset_mnist = np.std(x_train_255_mean, axis=0)  # (28, 28, 1)

# Excluding 0 values in order not to divide by 0
# Replacing them by 1
std_gray_dataset_mnist[std_gray_dataset_mnist == 0] = 1

# Implementing preprocessing by dividing on Standard Deviation
# Purpose: to scale pixels' values to a smaller range, that, in turn,
# is needed for training with respect to learnability and accuracy
x_train_255_mean_std = x_train_255_mean / std_gray_dataset_mnist
x_validation_255_mean_std = x_validation_255_mean / std_gray_dataset_mnist
x_test_255_mean_std = x_test_255_mean / std_gray_dataset_mnist


# Saving Standard Deviation to use it later in the course
# Initiating File object
# Creating file with name 'std_gray_dataset_mnist.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('mnist' + '/' + 'std_gray_dataset_mnist.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
    f.create_dataset('std', data=std_gray_dataset_mnist, dtype='f')


# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_mnist_gray_255_mean_std.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('mnist' + '/' + 'dataset_mnist_gray_255_mean_std.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255_mean_std, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# Check point
# Printing some values from matrices
print('Original:            ', x_train_255[0, 10, 10:15, 0])
print('- Mean Image:        ', x_train_255_mean[0, 10, 10:15, 0])
print('/ Standard Deviation:', x_train_255_mean_std[0, 10, 10:15, 0])
print()

# Check point
# Printing some values of Mean Image and Standard Deviation
print('Mean Image:          ', mean_gray_dataset_mnist[10, 10:15, 0])
print('Standard Deviation:  ', std_gray_dataset_mnist[10, 10:15, 0])
print()
...
# to this: + '\' +
# or to this: + '\\' +
with h5py.File(full_path_to_Section2 + '/' + 'dataset_cifar10.hdf5', 'r') as f:
    # Extracting saved arrays for training by appropriate keys
    # Saving them into new variables
    x_train = f['x_train']  # HDF5 dataset
    y_train = f['y_train']  # HDF5 dataset
...
# Check point
# Showing shapes of Numpy arrays with GRAY images
print('Numpy arrays of CIFAR-10 Dataset')
print(x_train.shape)
print(x_validation.shape)
print(x_test.shape)
print()
...
# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_cifar10_gray_255.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'dataset_cifar10_gray_255.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# (!) We calculate Mean Image only from training dataset
# And apply it to all sub-datasets
mean_gray_dataset_cifar10 = np.mean(x_train_255, axis=0)  # (32, 32, 1)
...
# Pixels' values are now in some range (from negative to positive),
# where the mean lies at zero
x_train_255_mean = x_train_255 - mean_gray_dataset_cifar10
x_validation_255_mean = x_validation_255 - mean_gray_dataset_cifar10
x_test_255_mean = x_test_255 - mean_gray_dataset_cifar10

# Saving Mean Image to use it later in the course
# Initiating File object
# Creating file with name 'mean_gray_dataset_cifar10.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'mean_gray_dataset_cifar10.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
    f.create_dataset('mean', data=mean_gray_dataset_cifar10, dtype='f')


# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_cifar10_gray_255_mean.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'dataset_cifar10_gray_255_mean.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255_mean, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# (!) We calculate Standard Deviation only from training dataset
# And apply it to all sub-datasets
std_gray_dataset_cifar10 = np.std(x_train_255_mean, axis=0)  # (32, 32, 1)

# Implementing preprocessing by dividing on Standard Deviation
# Purpose: to scale pixels' values to a smaller range, that, in turn,
# is needed for training with respect to learnability and accuracy
x_train_255_mean_std = x_train_255_mean / std_gray_dataset_cifar10
x_validation_255_mean_std = x_validation_255_mean / std_gray_dataset_cifar10
x_test_255_mean_std = x_test_255_mean / std_gray_dataset_cifar10

# Saving Standard Deviation to use it later in the course
# Initiating File object
# Creating file with name 'std_gray_dataset_cifar10.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'std_gray_dataset_cifar10.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
    f.create_dataset('std', data=std_gray_dataset_cifar10, dtype='f')


# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_cifar10_gray_255_mean_std.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'dataset_cifar10_gray_255_mean_std.hdf5', 'w') \
        as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255_mean_std, dtype='f')
...
# Check point
# Printing some values of Mean Image and Standard Deviation
print('Mean Image:          ', mean_gray_dataset_cifar10[0, :5, 0])
print('Standard Deviation:  ', std_gray_dataset_cifar10[0, :5, 0])
print()
