...
# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_cifar10_rgb_255.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'dataset_cifar10_rgb_255.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# (!) We calculate Mean Image only from training dataset
# And apply it to all sub-datasets
mean_rgb_dataset_cifar10 = np.mean(x_train_255, axis=0)  # (32, 32, 3)
...
# Pixels' values are now in some range (from negative to positive),
# where the mean lies at zero
x_train_255_mean = x_train_255 - mean_rgb_dataset_cifar10
x_validation_255_mean = x_validation_255 - mean_rgb_dataset_cifar10
x_test_255_mean = x_test_255 - mean_rgb_dataset_cifar10

# Saving Mean Image to use it later in the course
# Initiating File object
# Creating file with name 'mean_rgb_dataset_cifar10.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'mean_rgb_dataset_cifar10.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
    f.create_dataset('mean', data=mean_rgb_dataset_cifar10, dtype='f')


# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_cifar10_rgb_255_mean.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'dataset_cifar10_rgb_255_mean.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255_mean, dtype='f')
    f.create_dataset('y_train', data=y_train, dtype='i')
...
# (!) We calculate Standard Deviation only from training dataset
# And apply it to all sub-datasets
std_rgb_dataset_cifar10 = np.std(x_train_255_mean, axis=0)  # (32, 32, 3)

# Implementing preprocessing by dividing on Standard Deviation
# Purpose: to scale pixels' values to a smaller range, that, in turn,
# is needed for training with respect to learnability and accuracy
x_train_255_mean_std = x_train_255_mean / std_rgb_dataset_cifar10
x_validation_255_mean_std = x_validation_255_mean / std_rgb_dataset_cifar10
x_test_255_mean_std = x_test_255_mean / std_rgb_dataset_cifar10

# Saving Standard Deviation to use it later in the course
# Initiating File object
# Creating file with name 'std_rgb_dataset_cifar10.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'std_rgb_dataset_cifar10.hdf5', 'w') as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy array for Mean Image
    f.create_dataset('std', data=std_rgb_dataset_cifar10, dtype='f')


# Saving processed Numpy arrays into new HDF5 binary file
# Initiating File object
# Creating file with name 'dataset_cifar10_rgb_255_mean_std.hdf5'
# Opening it in writing mode by 'w'
# (!) On Windows, it might need to change
# this: + '/' +
# to this: + '\' +
# or to this: + '\\' +
with h5py.File('cifar10' + '/' + 'dataset_cifar10_rgb_255_mean_std.hdf5', 'w') \
        as f:
    # Calling methods to create datasets of given shapes and types
    # Saving Numpy arrays for training
    f.create_dataset('x_train', data=x_train_255_mean_std, dtype='f')
...
# Check point
# Printing some values of Mean Image and Standard Deviation
print('Mean Image:          ', mean_rgb_dataset_cifar10[0, :5, 0])
print('Standard Deviation:  ', std_rgb_dataset_cifar10[0, :5, 0])
print()
